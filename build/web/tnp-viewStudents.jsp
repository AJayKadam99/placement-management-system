       ...
       Connection con = db.connect();
        ...
        stmt2 = con.createStatement();
         ...
         rst2.next();
           ...
           rst = stmt.executeQuery("select distinct student.stud_id, first_name, last_name, roll_no, branch, profile_validate, status from student inner join applied on student.stud_id = applied.stud_id where comp_id = '"+compId+"' ");
    ...
    <section id="main">
      ...
      <section class="content-section">
        ...
        <section id="student-table">
            <form action="selectStudents.jsp?id=<%=compId%>" method="POST">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><input type="checkbox" name="selected" value="<%=rst.getString("stud_id")%>" style="zoom: 2;" <%=rst.getString("status").equals("selected") ? "checked" : ""%> ></td>
                <td><div class="btn btn-primary validate-btn" id="validate-<%=c%>" onclick="location.href='tnp-admin-validateStudents.jsp?id=<%=rst.getString("stud_id").toString()%>'" >View Details</div></td>
              </tr>
            ...
            <h3 class="text-center">No Students have applied for this company yet.</h3>
                    <%} 
                }
                catch(Exception ex){
